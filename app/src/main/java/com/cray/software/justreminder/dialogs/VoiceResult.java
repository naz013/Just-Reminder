    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        buttonEdit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(VoiceResult.this, ReminderManager.class)
