...
public class Prefs {
    ...
    public static final String DAYS_TO_BIRTHDAY = "days_to";
    ...
    public final static String CALENDAR_IMAGES = "calendar_images";
    ...
    public static final String BIRTHDAY_VIBRATION_STATUS = "birthday_vibration_status";
