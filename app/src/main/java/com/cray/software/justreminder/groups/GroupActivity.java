...
public class GroupActivity extends AppCompatActivity implements ColorPickerView.OnColorListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ColorSetter cs = ColorSetter.getInstance(GroupActivity.this);
