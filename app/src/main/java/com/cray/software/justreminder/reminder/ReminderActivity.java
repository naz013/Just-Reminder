...
public class ReminderActivity extends AppCompatActivity implements AdapterView.OnItemSelectedListener,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        colorSetter = ColorSetter.getInstance(ReminderActivity.this);
        ...
        new Handler().postDelayed(() -> ViewUtils.slideInDown(ReminderActivity.this, toolbar), 500);
    }
    ...
    private void initToolbar() {
        ...
        toolbar.setOnMenuItemClickListener(item1 -> {
                    switch (item1.getItemId()) {
                        ...
                        case R.id.action_custom_melody:
                            if(Permissions.checkPermission(ReminderActivity.this,
                                ...
                                Permissions.requestPermission(ReminderActivity.this, 330,
                                        Permissions.READ_EXTERNAL);
                            }
                            return true;
        ...
        insertVoice.setOnClickListener(v -> SuperUtil.startVoiceRecognitionActivity(ReminderActivity.this,
                VOICE_RECOGNITION_REQUEST_CODE, true));
        changeExtra.setOnClickListener(v -> startActivityForResult(new Intent(ReminderActivity.this, ExtraPickerDialog.class)
        ...
        category.setOnClickListener(v -> Dialogues.selectCategory(ReminderActivity.this, categoryId, ReminderActivity.this));
    }
    ...
    private void selectVolume() {
        Intent i = new Intent(ReminderActivity.this, SelectVolume.class).putExtra("int", 1);
    ...
    private void deleteReminder() {
        if (mItem != null) {
            ...
            if (isArchived == 1) {
                ...
                Messages.toast(ReminderActivity.this, getString(R.string.deleted));
    ...
    private void selectRadius() {
        Intent i = new Intent(ReminderActivity.this, TargetRadius.class);
        i.putExtra("item", 1);
    ...
    private void chooseLEDColor() {
        Intent i = new Intent(ReminderActivity.this, LedColor.class);
    ...
    private JsonModel getData() {
        ...
        if (isShoppingAttached()){
            ...
            if (fragment.getCount() == 0) {
                ...
                for (ShoppingListItem shoppingList : fragment.getData()) {
            ...
            if (item != null) {
                ...
                if (isDone != 1 && isArchive != 1) {
                    if (type.contains(Constants.TYPE_LOCATION) && eventTime > 0) {
                        new PositionDelayReceiver().setDelay(ReminderActivity.this, id);
                    } else {
                        new AlarmReceiver().enableReminder(ReminderActivity.this, id);
                    }
                }
            }
        }
        new Notifier(ReminderActivity.this).recreatePermanent();
        finish();
    }
    ...
    private void switchIt(int position){
        ...
        switch (position){
            case 0:
                ...
                break;
            case 2:
                if (Permissions.checkPermission(ReminderActivity.this, Permissions.CALL_PHONE,
                        Permissions.SEND_SMS, Permissions.READ_CONTACTS, Permissions.READ_CALLS)) {
                    attachWeekDayReminder();
                } else {
                    Permissions.requestPermission(ReminderActivity.this, 113, Permissions.CALL_PHONE,
            ...
            case 1:
                ...
                break;
            case 3:
                if (Permissions.checkPermission(ReminderActivity.this, Permissions.CALL_PHONE, Permissions.READ_CALLS)) {
                    attachCall();
                } else {
                    Permissions.requestPermission(ReminderActivity.this, 109, Permissions.CALL_PHONE, Permissions.READ_CALLS);
                }
                break;
            case 4:
                if (Permissions.checkPermission(ReminderActivity.this, Permissions.SEND_SMS, Permissions.READ_CALLS)) {
                    attachMessage();
                } else {
                    Permissions.requestPermission(ReminderActivity.this, 108, Permissions.SEND_SMS, Permissions.READ_CALLS);
                }
                break;
            case 5:
                if (LocationUtil.checkGooglePlayServicesAvailability(ReminderActivity.this)) {
                    if (Permissions.checkPermission(ReminderActivity.this, Permissions.ACCESS_FINE_LOCATION,
                        ...
                        Permissions.requestPermission(ReminderActivity.this, 105, Permissions.ACCESS_COARSE_LOCATION,
                ...
                break;
            case 6:
                if (SuperUtil.isSkypeClientInstalled(ReminderActivity.this)) {
                    attachSkype();
                } else {
                    spinner.setSelection(0);
                    SuperUtil.installSkype(ReminderActivity.this);
                }
                break;
            case 7:
                attachApplication();
            ...
            case 8:
                if (Permissions.checkPermission(ReminderActivity.this, Permissions.CALL_PHONE,
                    ...
                    Permissions.requestPermission(ReminderActivity.this, 114, Permissions.CALL_PHONE,
                            Permissions.READ_CONTACTS, Permissions.SEND_SMS, Permissions.READ_CALLS);
                }
                break;
            case 9:
                if (LocationUtil.checkGooglePlayServicesAvailability(ReminderActivity.this)) {
                    if (Permissions.checkPermission(ReminderActivity.this, Permissions.ACCESS_FINE_LOCATION,
                        ...
                        Permissions.requestPermission(ReminderActivity.this, 106,
            ...
            case 12:
                if (LocationUtil.checkGooglePlayServicesAvailability(ReminderActivity.this)) {
                    if (Permissions.checkPermission(ReminderActivity.this,
                        ...
                        Permissions.requestPermission(ReminderActivity.this, 121,
                                Permissions.ACCESS_COARSE_LOCATION, Permissions.ACCESS_FINE_LOCATION);
                    }
                } else spinner.setSelection(0);
                break;
    ...
    public void onRequestPermissionsResult(int requestCode, @NonNull String[] permissions,
        ...
        switch (requestCode){
            ...
            case 107:
                if (grantResults[0] == PackageManager.PERMISSION_GRANTED){
                    SuperUtil.selectContact(ReminderActivity.this, Constants.REQUEST_CODE_CONTACTS);
                } else {
                    Permissions.showInfo(ReminderActivity.this, Permissions.READ_CONTACTS);
                }
                break;
            case 108:
                if (grantResults[0] == PackageManager.PERMISSION_GRANTED)
