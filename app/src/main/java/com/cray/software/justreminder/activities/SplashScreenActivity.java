...
public class SplashScreenActivity extends AppCompatActivity {
    ...
    private void migrateToNewDb() throws SQLiteException, IllegalStateException {
        ...
        stopService(new Intent(SplashScreenActivity.this, CheckPosition.class));
        ...
        if (c != null && c.moveToFirst()){
            ...
            do {
                ...
                receiver.cancelAlarm(SplashScreenActivity.this, id);
                ArrayList<Integer> listW = new ArrayList<>();
                if (weekdays != null) {
                    listW = ReminderUtils.getRepeatArray(weekdays);
                }
                due = TimeCount.getInstance(SplashScreenActivity.this).generateDateTime(type, myDay, due, repCode * TimeCount.DAY, listW, count, 0);
                ...
                if (type.matches(Constants.TYPE_SHOPPING_LIST)){
                    ...
                    ArrayList<ShoppingListItem> shoppingLists =
                            ShoppingListDataProvider.load(SplashScreenActivity.this, id);
                    for (ShoppingListItem item : shoppingLists){
                ...
                receiver.enableReminder(SplashScreenActivity.this, mId);
            } while (c.moveToNext());
        }
        if (c != null) c.close();
        db.close();
