...
public class TaskListActivity extends AppCompatActivity implements ColorPickerView.OnColorListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        cSetter = ColorSetter.getInstance(TaskListActivity.this);
    ...
    private void saveTaskList() {
        ...
        if (isNew) {
            new TaskListAsync(TaskListActivity.this, listName, id, mItem.getColor(), null, TasksConstants.INSERT_TASK_LIST).execute();
        } else {
            new TaskListAsync(TaskListActivity.this, listName, id, mItem.getColor(), mItem.getListId(), TasksConstants.UPDATE_TASK_LIST).execute();
        }
        finish();
    }
    ...
    private void deleteList() {
        if (mItem != null){
            ...
            new TaskListAsync(TaskListActivity.this, null, 0, 0, listId, TasksConstants.DELETE_TASK_LIST).execute();
            if (def == 1) {
