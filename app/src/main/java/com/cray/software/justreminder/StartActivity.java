...
import com.cray.software.justreminder.templates.TemplateActivity;
...
public class StartActivity extends AppCompatActivity implements NavigationCallbacks, DateCallback {
    ...
    private void performClick() {
        if (mTag.matches(FRAGMENT_EVENTS) || mTag.matches(ACTION_CALENDAR)) {
            ...
            startActivity(new Intent(StartActivity.this, ActionPickerDialog.class)
            ...
            if (new GoogleTasks(StartActivity.this).isLinked()) {
                startActivity(new Intent(StartActivity.this, TaskActivity.class)
            ...
            startActivity(new Intent(StartActivity.this, NotesActivity.class));
            ...
            if (LocationUtil.checkGooglePlayServicesAvailability(StartActivity.this)) {
                startActivity(new Intent(StartActivity.this, AddPlaceActivity.class));
            }
        } else if (mTag.matches(FRAGMENT_TEMPLATES)) {
            startActivity(new Intent(StartActivity.this, TemplateActivity.class));
        }
    }
    ...
    public void onItemSelected(String tag) {
        ...
        if (tag != null) {
            ...
            if (tag.matches(FRAGMENT_ACTIVE)) {
                ...
                SuperUtil.startVoiceRecognitionActivity(StartActivity.this,
                ...
                if (!new GoogleTasks(this).isLinked()) {
                    if (Permissions.checkPermission(StartActivity.this,
                        ...
                        Permissions.requestPermission(StartActivity.this, 103,
                                Permissions.GET_ACCOUNTS, Permissions.READ_EXTERNAL,
                                Permissions.WRITE_EXTERNAL);
                    }
                }
    ...
    private void askNotification(final String note, final long id) {
        ...
        buttonYes.setOnClickListener(v -> {
            new Notifier(StartActivity.this).showNoteNotification(NoteHelper.getInstance(this).getNote(id));
    ...
    private void askReminder(final String note, final long noteId) {
        ...
        buttonReminderYes.setOnClickListener(v -> {
            ...
            long remId = new DateType(StartActivity.this, Constants.TYPE_REMINDER).save(new ReminderItem(jsonModel));
            NoteHelper.getInstance(StartActivity.this).linkReminder(noteId, remId);
            if (mTag.matches(FRAGMENT_NOTE) || mTag.matches(FRAGMENT_ACTIVE)) {
                onItemSelected(mTag);
            }
        });
    ...
    public void onBackPressed() {
        ...
        Messages.toast(StartActivity.this, getString(R.string.press_again_to_exit));
    ...
    private void getAndUseAuthTokenInAsyncTask(Account account) {
        AsyncTask<Account, String, String> task = new AsyncTask<Account, String, String>() {
            ...
            protected void onPreExecute() {
                progressDlg = new ProgressDialog(StartActivity.this, ProgressDialog.STYLE_SPINNER);
