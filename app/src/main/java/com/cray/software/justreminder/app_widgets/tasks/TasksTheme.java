...
public class TasksTheme implements Parcelable {
    ...
    public static ArrayList<TasksTheme> getThemes(Context context) {
        ...
        list.add(new TasksTheme(R.color.indigoPrimary, R.color.material_grey,
                ...
                R.drawable.ic_settings_white_24dp, getResColor(context, R.color.whitePrimary), "Indigo", R.color.whitePrimary,
                getResColor(context, R.color.blackPrimary)));

        list.add(new TasksTheme(R.color.tealPrimaryDark, R.color.material_grey,
                getResColor(context, R.color.whitePrimary), R.drawable.ic_add_white_24dp,
                R.drawable.ic_settings_white_24dp, getResColor(context, R.color.whitePrimary), "Teal", R.color.whitePrimary,
                getResColor(context, R.color.blackPrimary)));

        list.add(new TasksTheme(R.color.limePrimaryDark, R.color.material_grey,
                getResColor(context, R.color.whitePrimary), R.drawable.ic_add_white_24dp,
                R.drawable.ic_settings_white_24dp, getResColor(context, R.color.whitePrimary), "Lime", R.color.whitePrimary,
                getResColor(context, R.color.blackPrimary)));

        list.add(new TasksTheme(R.color.bluePrimaryDark, R.color.material_grey,
                getResColor(context, R.color.whitePrimary), R.drawable.ic_add_white_24dp,
                R.drawable.ic_settings_white_24dp, getResColor(context, R.color.whitePrimary), "Blue", R.color.whitePrimary,
                getResColor(context, R.color.blackPrimary)));

        list.add(new TasksTheme(R.color.material_grey, R.color.material_divider,
                getResColor(context, R.color.whitePrimary), R.drawable.ic_add_white_24dp,
                R.drawable.ic_settings_white_24dp, getResColor(context, R.color.blackPrimary), "Gray", R.color.whitePrimary,
                getResColor(context, R.color.blackPrimary)));

        list.add(new TasksTheme(R.color.greenPrimaryDark, R.color.material_grey,
                getResColor(context, R.color.whitePrimary), R.drawable.ic_add_white_24dp,
                R.drawable.ic_settings_white_24dp, getResColor(context, R.color.whitePrimary), "Green", R.color.whitePrimary,
                getResColor(context, R.color.blackPrimary)));

        list.add(new TasksTheme(R.color.blackPrimary, R.color.blackPrimary,
                getResColor(context, R.color.whitePrimary), R.drawable.ic_add_white_24dp,
                R.drawable.ic_settings_white_24dp, getResColor(context, R.color.whitePrimary), "Dark", R.color.whitePrimary,
                getResColor(context, R.color.blackPrimary)));
        ...
        list.add(new TasksTheme(R.color.whitePrimary, R.color.whitePrimary,
                ...
                R.drawable.ic_settings_black_24dp, getResColor(context, R.color.blackPrimary), "White", R.color.material_grey,
                getResColor(context, R.color.whitePrimary)));

        list.add(new TasksTheme(R.color.orangePrimaryDark, R.color.material_grey,
                getResColor(context, R.color.whitePrimary), R.drawable.ic_add_white_24dp,
                R.drawable.ic_settings_white_24dp, getResColor(context, R.color.whitePrimary), "Orange", R.color.whitePrimary,
                getResColor(context, R.color.blackPrimary)));

        list.add(new TasksTheme(R.color.redPrimaryDark, R.color.material_grey,
                getResColor(context, R.color.whitePrimary), R.drawable.ic_add_white_24dp,
                R.drawable.ic_settings_white_24dp, getResColor(context, R.color.whitePrimary), "Red", R.color.whitePrimary,
                getResColor(context, R.color.blackPrimary)));

        list.add(new TasksTheme(R.color.material_grey_dialog, R.color.orangeAccent,
                getResColor(context, R.color.whitePrimary), R.drawable.ic_add_white_24dp,
                R.drawable.ic_settings_white_24dp, getResColor(context, R.color.blackPrimary), "Simple Orange", R.color.whitePrimary,
                getResColor(context, R.color.blackPrimary)));

        list.add(new TasksTheme(R.color.simple_transparent_header_color, R.color.simple_transparent_header_color,
                getResColor(context, R.color.whitePrimary), R.drawable.ic_add_white_24dp,
                R.drawable.ic_settings_white_24dp, getResColor(context, R.color.whitePrimary), "Transparent Light", R.color.material_grey,
                getResColor(context, R.color.whitePrimary)));

        list.add(new TasksTheme(R.color.simple_transparent_header_color, R.color.simple_transparent_header_color,
                getResColor(context, R.color.blackPrimary), R.drawable.ic_add_black_24dp,
                R.drawable.ic_settings_black_24dp, getResColor(context, R.color.blackPrimary), "Transparent Dark", R.color.whitePrimary,
                getResColor(context, R.color.blackPrimary)));

        list.add(new TasksTheme(R.color.pinkAccent, R.color.material_grey,
                getResColor(context, R.color.whitePrimary), R.drawable.ic_add_white_24dp,
                R.drawable.ic_settings_white_24dp, getResColor(context, R.color.whitePrimary), "Simple Pink", R.color.whitePrimary,
                getResColor(context, R.color.blackPrimary)));
        return list;
    }
