...
public class MonthDayReceiver extends BroadcastReceiver {
    ...
    public void setAlarm(Context context, long id) {
        ...
        Intent intent = new Intent(context, MonthDayReceiver.class);
        ...
        if (dbTime > current) alarmMgr.setRepeating(AlarmManager.RTC_WAKEUP, calendar.getTimeInMillis(),
                AlarmManager.INTERVAL_DAY, alarmIntent);
        else alarmMgr.setRepeating(AlarmManager.RTC_WAKEUP, calendar.getTimeInMillis() + AlarmManager.INTERVAL_DAY,
                AlarmManager.INTERVAL_DAY, alarmIntent);
        DB.close();
    }
