...
public class CaldroidFragment extends DialogFragment {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        LinearLayout calendar_bg = (LinearLayout) view.findViewById(R.id.calendar_bg);
        SharedPreferences prefs = getActivity().getSharedPreferences("ui_settings", Context.MODE_PRIVATE);
        calendar_bg.setBackgroundColor(getResources().getColor(android.R.color.transparent));
        ...
        if (prefs.getBoolean("dark_theme", false)){
            monthTitleTextView.setTextColor(getResources().getColor(R.color.caldroid_white));
        } else monthTitleTextView.setTextColor(getResources().getColor(R.color.grey_dark_x));
