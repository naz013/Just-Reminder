...
public class FloatingActionsMenu extends ViewGroup {
  ...
  public void setButtonColorNormal(int color){
  ...
  public void setButtonColorNormalResId(@ColorRes int colorNormal){
    setButtonColorNormal(getColor(colorNormal));
  }
  ...
  public void setButtonColorPressedResId(@ColorRes int colorPressed){
    setButtonColorPressed(getColor(colorPressed));
  }
